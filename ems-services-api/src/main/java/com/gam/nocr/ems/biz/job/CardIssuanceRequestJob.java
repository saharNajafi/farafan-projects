...
public class CardIssuanceRequestJob implements InterruptableJob {

	private static final Logger logger = BaseLog
			.getLogger(CardIssuanceRequestJob.class);
	...
	public void execute(JobExecutionContext jobExecutionContext)
		...
		logger.info("CardIssuanceRequestJob execute method is started...");
		...
		logger.info("CardIssuanceRequestJob execute method is finished.");
	}
