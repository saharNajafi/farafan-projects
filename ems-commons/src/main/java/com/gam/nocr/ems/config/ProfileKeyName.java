...
public class ProfileKeyName {
    ...
    public static final String KEY_FING_ISO_19794_NORMAL_FORMAT_MAX_SIZE_BYTES = EMS_PROFILE_ROOT + ".ccos.ISO19794NormalFormatMaxSizeBytes";
    ...
    public static final String KEY_SCANNED_DOCUMENT_FACE_IMAGE_COMPRESSION_MAX_SIZE_LIMIT_BYTES = EMS_PROFILE_ROOT + ".ccos.document.FaceImageCompressionMaxSizeLimitBytes";
    public static final String KEY_SCANNED_DOCUMENT_SERIAL_NUMBER_IMAGE_COMPRESSION_MAX_SIZE_LIMIT_BYTES = EMS_PROFILE_ROOT + ".ccos.document.SerialNumberImageCompressionMaxSizeLimitBytes";
