...
public class DataExceptionCode extends BaseRuntimeExceptionCode {
    ...
    public static final String GLB_011_MSG = "he count operation could not be executed";
    ...
    public static final String CRC_011 = "EMS_D_CRC_011";
    public static final String CRC_012 = "EMS_D_CRC_012";
