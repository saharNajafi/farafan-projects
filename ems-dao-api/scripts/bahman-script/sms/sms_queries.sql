alter table emst_card_request add(CRQ_REQUESTED_SMS_STATUS number(3,0) default 0);
...
Insert into INFT_SYSTEM_PROFILE (SPF_ID,SPF_PRF_ID,SPF_DATE,SPF_CLOB) values (4000,4000,null,'متقاضی گرامی {fname} {lname} کارت هوشمند شما آماده با شماره دسته  {bnum}تحویل است. لطفاًب برای اخذ آن به {dname} مراجعه نمایید');
