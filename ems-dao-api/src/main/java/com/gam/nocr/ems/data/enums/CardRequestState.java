...
public enum CardRequestState {
	...
	INACTIVE, // NOT USED
	REGISTERED, SEND_TO_EMS, // NOT USED
	PENDING_FOR_EMS, RECEIVED_BY_EMS, PENDING_IMS, VERIFIED_IMS, NOT_VERIFIED_BY_IMS, RESERVED, STOPPED_NOT_REFER_TO_CCOS, // NOT
																															// USED
	READY_TO_RESERVE, // NOT USED
	REFERRED_TO_CCOS, NOT_REFERRED_TO_CCOS, // NOT USED
	READY_TO_LIMITED_RESERVE, // NOT USED
	LIMITED_RESERVED, // NOT USED
	STOPPED_NOT_FOLLOW_LIMITED_RESERVE, DOCUMENT_AUTHENTICATED, SCANNED_DOCUMENTS, // NOT
																					// USED
	SCANNED_FACE, // NOT USED
	SCANNED_FINGER, // NOT USED
	APPROVED_BY_MES, APPROVED, SENT_TO_AFIS, REVOKED_BY_AFIS, // NOT USED
	APPROVED_BY_AFIS, PENDING_ISSUANCE, ISSUED, READY_TO_DELIVER, PENDING_TO_DELIVER_BY_CMS, DELIVERED, UNSUCCESSFUL_DELIVERY, // NOT
																																// USED
	UNSUCCESSFUL_DELIVERY_BECAUSE_OF_DAMAGE, UNSUCCESSFUL_DELIVERY_BECAUSE_OF_BIOMETRIC, NOT_DELIVERED, STOPPED, REPEALED, CMS_ERROR, CMS_PRODUCTION_ERROR, IMS_ERROR, SCANNED_DOC_FACE, // NOT
																																															// USED
