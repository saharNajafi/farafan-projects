...
public interface CardRequestDAO extends EmsBaseDAO<CardRequestTO> {
     ...
     *
     * @param oldState an instance of type {@link CardRequestState} which represents
     *                 the old state
     * @param newState an instance of type {@link CardRequestState} which represents
     *                 the new state
     * @throws BaseException
     */
     ...
     * a key in the map
     *
     * @param cardRequestTOList a list of type {@link CardRequestTO}
     * @param map               a map with key/value of type {@link Map<CardRequestOrigin,
     ...
     *
     * @param state  is an instance of type {@link CardRequestState}
     * @param origin is an instance of type {@link CardRequestOrigin}
     ...
     * @param cardRequestState is an enumeration of type {@link CardRequestState}, which
     ...
     *
     * @param cardRequestedAction is an instance of type {@link CardRequestedAction}
     ...
     *
     * @param id is an instance of type {@link java.lang.Long} which identifies
