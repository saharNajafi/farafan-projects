 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://portalws.ws.web.portal.nocr.gam.com/}reservationWTO" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class TransferReservationResponse {
    ...
    protected List<ReservationWTO> _return;
     ...
     * 
     */
    public List<ReservationWTO> getReturn() {
        if (_return == null) {
            _return = new ArrayList<ReservationWTO>();
        }
        return this._return;
    }
