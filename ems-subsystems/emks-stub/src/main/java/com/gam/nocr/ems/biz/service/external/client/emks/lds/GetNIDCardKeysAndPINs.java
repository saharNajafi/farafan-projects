...
@XmlRootElement(name = "GetNIDCardKeysAndPINs")
public class GetNIDCardKeysAndPINs {

    @XmlElementRef(name = "CardInfo", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
