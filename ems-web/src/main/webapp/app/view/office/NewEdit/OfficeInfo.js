    ...
    getReadOnlyFields: function () {
        return [
...

            {
                ...
                fieldLabel: 'ظرفیت',
                id: EmsObjectName.officeNewEdit.oficCapacity
            },
            // {
...
//		        }
    ...
    getEditableFields: function () {
        ...
        this.EditableField = [
            {
                fieldLabel: 'کد دفتر',
                id: EmsObjectName.officeNewEdit.oficCode,
                name: EmsObjectName.officeNewEdit.oficCode,
                maskRe: /\d/i,
                allowBlank: false,
                maxLength: 10,
                enforceMaxLength: 10
            ...
            },
            {
                fieldLabel: 'فکس',
                id: EmsObjectName.officeNewEdit.oficFax,
                name: EmsObjectName.officeNewEdit.oficFax,
                maskRe: /\d/i,
                allowBlank: false,
                maxLength: 20,
                enforceMaxLength: 20
            },
            {
                fieldLabel: 'تلفن ثابت',
                id: EmsObjectName.officeNewEdit.oficTel,
                name: EmsObjectName.officeNewEdit.oficTel,
                maskRe: /\d/i,
                allowBlank: false,
                maxLength: 20,
                enforceMaxLength: 20
                ...
                listeners: {
                    focus: function (autocomplete, e) {
                        if (Ext.getCmp(EmsObjectName.officeNewEdit.oficSuperRegisterOffice).getValue()) {
                            autocomplete.getStore().readParams.additionalParams =
                                Ext.JSON.encode({
                                    'superDepartmentID': Ext.getCmp(EmsObjectName.officeNewEdit.oficSuperRegisterOffice).getValue(),
                                    'officeType': 'NOCR'
                                });
                        } else {
