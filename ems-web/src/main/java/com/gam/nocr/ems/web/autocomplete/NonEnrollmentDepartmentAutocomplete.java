...
/**
 * Handler for non enrollment departments autocomplete used in 3S forms like department edit form
 *
 * @author Soheil Toodeh Fallah (fallah@gamelectronics.com)
 */
public class NonEnrollmentDepartmentAutocomplete extends BaseAutocompleteHandler {

    private static final Logger logger = BaseLog.getLogger(NonEnrollmentDepartmentAutocomplete.class);

    @Override
    protected String getAutocompleteProfileKeyName() {
        return "nonEnrollmentDepartment";
    }
    ...
    /**
     * Fetches the list of non enrollment departments having given searchString in their title
     *
    ...
    public SearchResult getSearchResult(String searchString, int from, int to, Integer depId, Integer perId, String orderBy, Map additionalParams) {
        try {
            ...
            return departmentDelegator.fetchNonEnrollmentDepartments(userProfile, searchString, from, to, orderBy);
