...
/**
 * Handler for persons autocomplete used in 3S forms like enrollment office edit form
 *
 * @author Soheil Toodeh Fallah (fallah@gamelectronics.com)
 */
public class PersonAutocomplete extends BaseAutocompleteHandler {

    private static final Logger logger = BaseLog.getLogger(PersonAutocomplete.class);
    ...
    /**
     * Fetches the list of persons having given searchString in their title
     *
    ...
    public SearchResult getSearchResult(String searchString, int from, int to, Integer depId, Integer perId, String orderBy, Map additionalParams) {
        try {
            ...
            return personDelegator.fetchPersons(userProfile, searchString, from, to, orderBy);
