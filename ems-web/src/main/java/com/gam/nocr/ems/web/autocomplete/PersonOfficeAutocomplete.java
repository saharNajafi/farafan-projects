...
/**
 * Handler for person-enrollment office autocomplete used in 3S forms like enrollment office edit form and returns the
 * list of enrollment offices which given person has access to (including its own enrollment office)
 *
 * @author <a href="mailto:moghaddam@gamelectronics.com">Ehsan Zaery Moghaddam</a>
 */
public class PersonOfficeAutocomplete extends BaseAutocompleteHandler {
    ...
    public PersonOfficeAutocomplete() {
    ...
    /**
     * Fetches the list of enrollment offices having given searchString in their title base on current user's department
     *
    ...
    public SearchResult getSearchResult(String searchString, int from, int to, Integer depId, Integer perId, String orderBy, Map additionalParams) {
        ...
        try {
            return enrollmentOfficeDelegator.fetchPersonEnrollments(userProfile, searchString, from, to, orderBy, additionalParams);
