 ...
 */
public class ProvinceAutocomplete extends BaseAutocompleteHandler {

    private static final Logger logger = BaseLog.getLogger(ProvinceAutocomplete.class);
    ...
    public SearchResult getSearchResult(String searchString, int from, int to, Integer depId, Integer perId, String orderBy, Map additionalParams) {
        try {
            ...
            return departmentDelegator.fetchProvinces(userProfile, searchString, from, to, orderBy);
