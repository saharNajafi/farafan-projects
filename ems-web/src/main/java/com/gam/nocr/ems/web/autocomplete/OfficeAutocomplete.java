 ...
 */
public class OfficeAutocomplete extends BaseAutocompleteHandler {

    private static final Logger logger = BaseLog.getLogger(OfficeAutocomplete.class);
    ...
    public SearchResult getSearchResult(String searchString, int from, int to, Integer depId, Integer perId, String orderBy, Map additionalParams) {
        try {
            ...
            return enrollmentOfficeDelegator.fetchOfficesAutoComplete(userProfile, searchString, from, to, orderBy, additionalParams);
