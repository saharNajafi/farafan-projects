...
/**
 * Handler for permissions autocomplete used in 3S forms like person edit form. It calls GAAS web services to fetch the
 * results
 *
 * @author <a href="mailto:saadat@gamelectronics.com">Alireza Saadat</a>
 */
public class PermissionsAutocomplete extends BaseAutocompleteHandler {

    private static final Logger logger = BaseLog.getLogger(PermissionsAutocomplete.class);
    ...
    /**
     * Fetches the list of roles having given searchString in their title
     *
    ...
    public SearchResult getSearchResult(String searchString, int from, int to, Integer depId, Integer perId, String orderBy, Map additionalParams) {
        try {
            ...
            logger.info("++++++++++++++++++++++++++++++++++++++");
            logger.info("++++++++++++++++++++++++++++++++++++++");
            return personDelegator.fetchPermissions(userProfile, searchString, from, to, orderBy);
