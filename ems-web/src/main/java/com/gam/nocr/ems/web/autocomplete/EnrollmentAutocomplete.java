 ...
 */
public class EnrollmentAutocomplete extends BaseAutocompleteHandler {

    private static final Logger logger = BaseLog.getLogger(EnrollmentAutocomplete.class);

    private EnrollmentOfficeDelegator enrollmentOfficeDelegator;

    public EnrollmentAutocomplete() {
    ...
    public SearchResult getSearchResult(String searchString, int from, int to, Integer depId, Integer perId, String orderBy, Map additionalParams) {
        try {
            ...
            return enrollmentOfficeDelegator.fetchEnrollments(userProfile, searchString, from, to, orderBy, additionalParams);
