...
drop table GAM_MAIN_EMS.EMST_WORKSTATION_INFO purge ;
  ...
  CREATE TABLE GAM_MAIN_EMS."EMST_WORKSTATION_INFO"
   (    "WSI_ID" NUMBER(19,0) NOT NULL ENABLE,
    "WSI_CCOS_VERSION" VARCHAR2(255 CHAR) NOT NULL ENABLE,
    "WSI_CPU_INFO" VARCHAR2(255 CHAR) NOT NULL ENABLE,
    "WSI_GATHER_STATE" NUMBER(5,0) NOT NULL ENABLE,
    "WSI_HAS_DOTNET_FRAMWORK45" NUMBER(5,0) NOT NULL ENABLE,
    "WSI_IP_ADDRESS" VARCHAR2(255 CHAR) NOT NULL ENABLE,
    "WSI_LAST_MODIFIED_DATE" TIMESTAMP (6) NOT NULL ENABLE,
    "WSI_MEMORY_CAPACITY" VARCHAR2(255 CHAR) NOT NULL ENABLE,
    "WSI_OS_VERSION" VARCHAR2(255 CHAR) NOT NULL ENABLE,
    "WSI_USERNAME" VARCHAR2(255 CHAR) NOT NULL ENABLE,
