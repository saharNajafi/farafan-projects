...
ALTER TABLE COMM_DEV_EMS.EMST_REGISTRATION_PAYMENT
  ADD (RPY_TERMINAl_CODE  VARCHAR2(50 CHAR));

ALTER TABLE COMM_DEV_EMS.EMST_REGISTRATION_PAYMENT
  ADD (RPY_MERCHANT_CODE  VARCHAR2(50 CHAR));
...
comment on column gam_main_ems.emst_registration_payment.rpy_payment_type is '1=IPG 2=PCPOS نوع پرداخت';
 ...
 NOCOMPRESS LOGGING
  TABLESPACE "USERS"
 LOB ("CTL_ADDITIONAL_DATA") STORE AS BASICFILE (
  TABLESPACE "USERS" ENABLE STORAGE IN ROW CHUNK 8192 RETENTION
  NOCACHE LOGGING )
 LOB ("CTL_EDITED_VALUE") STORE AS BASICFILE (
  TABLESPACE "USERS" ENABLE STORAGE IN ROW CHUNK 8192 RETENTION
  NOCACHE LOGGING ) ;
