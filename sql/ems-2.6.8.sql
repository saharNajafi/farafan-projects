...
comment on column gam_main_ems.emst_registration_payment.rpy_payment_type is '1=IPG 2=PCPOS نوع پرداخت';
  ...
  CREATE TABLE "EMS_LOG"."EMST_CUSTOME_LOG"
   (	"CUSTOM_ID" NUMBER(19,0) NOT NULL ENABLE,
	"CUSTOM_ACTION" VARCHAR2(255 CHAR) NOT NULL ENABLE,
	"CUSTOM_IS_ACTION_SUCCESS" NUMBER(1,0),
	"CUSTOM_ACTOR" VARCHAR2(255 CHAR) NOT NULL ENABLE,
	"CUSTOM_ADDITIONAL_DATA" CLOB,
	"CUSTOM_DATE" TIMESTAMP (6) NOT NULL ENABLE,
	"CUSTOM_EDITED_VALUE" CLOB,
	"CUSTOM_ENTITY_ID" VARCHAR2(255 CHAR) NOT NULL ENABLE,
	"CUSTOM_ENTITY_NAME" VARCHAR2(255 CHAR) NOT NULL ENABLE,
