...
/*			if (EmsUtil.checkString(criteria.getOrderBy())) {
    ...
    public List<CitizenWTO> fetchCCOSRegistrationCartableCardRequests(
        ...
        try {
            queryBuffer
                    .append("select firstname, lastname, fathername, nationalId, enrolledDate, reservedDate, requestId, citizenId, state, originalOfficeId, originalOfficeName, trackingId, requestType, hasVipImage, isPaid, paidDate, requestedAction, paymentSuccess, paymentResCode ,attendDate, paidBank ")
                    .append(" from ( ")
