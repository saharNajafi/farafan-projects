...
public class OfficeSettingServiceImpl extends EMSAbstractService
    ...
    public Long update(OfficeSettingVTO officeSettingVTO) throws BaseException {
        ...
        try {
            ...
            if (officeSettingTO == null)
                throw new ServiceException(BizExceptionCode.OST_S_003,
                        BizExceptionCode.OST_S_003_MSG, new Long[]{officeSettingVTO.getId()});
            ...
            throw new ServiceException(BizExceptionCode.OST_S_011, BizExceptionCode.OST_S_011_MSG, e);
        }
    ...
    private Set<FeatureExtractIdsTO> getFeatureExtractIdsList(Long fenId, Long fecId) throws BaseException{
        ...
        try {
            ...
            if (featureExtractNormal == null)
                throw new ServiceException(BizExceptionCode.OST_S_007
                        , BizExceptionCode.OST_S_007_MSG, new Long[]{fenId});
            if (featureExtractCC == null)
                throw new ServiceException(BizExceptionCode.OST_S_008
                         , BizExceptionCode.OST_S_008_MSG, new Long[]{fecId});
            featureExtractIdsTOList.add(featureExtractNormal);
            featureExtractIdsTOList.add(featureExtractCC);
        } catch (BaseException e) {
            throw new ServiceException(BizExceptionCode.OST_S_014, BizExceptionCode.OST_S_014_MSG, e);
        }
    ...
    private FeatureExtractIdsDAO getFeatureExtractIdsDAO() throws BaseException {
        try {
            ...
            throw new ServiceException(BizExceptionCode.OST_S_006,
    ...
    private OfficeSettingDAO getOfficeSettingDAO() throws BaseException {
        try {
            ...
            throw new ServiceException(BizExceptionCode.OST_S_015,
                    BizExceptionCode.GLB_001_MSG, e,
