...
import com.gam.nocr.ems.biz.service.internal.impl.IMSManagementServiceLocal;
            ...
            try {
                ...
                if (personInfo != null) {
                    ...
                    if (!EmsUtil.checkListSize(estelamResults)) {
                        ...
                        logger.error(BizExceptionCode.NIO_010, BizExceptionCode.NIO_010_MSG + ":" + errorMessage);
