...
import static com.gam.nocr.ems.config.EMSLogicalNames.DAO_BLACK_LIST;
import static com.gam.nocr.ems.config.EMSLogicalNames.DAO_BUSINESSLOG;
...
import static com.gam.nocr.ems.config.EMSLogicalNames.DAO_PHOTO_VIP;
import static com.gam.nocr.ems.config.EMSLogicalNames.DAO_SERVICE_DOCTYPE;
import static com.gam.nocr.ems.config.EMSLogicalNames.SRV_CARD_MANAGEMENT;
import static com.gam.nocr.ems.config.EMSLogicalNames.SRV_IMS_MANAGEMENT;
...
import com.gam.nocr.ems.data.dao.EncryptedCardRequestDAO;
...
import com.gam.nocr.ems.data.dao.PhotoVipDAO;
...
import com.gam.nocr.ems.data.enums.CardRequestAuthenticity;
...
//		}
 ...
 // haghshenas
	private void addBiometricInfoData(long requestId) throws BaseException {
    ...
    private void addFingerDataFromVip(long requestId, ArrayList<BiometricTO> biometricDatas) throws BaseException {
        addBiometricData(requestId, biometricDatas);
        addBiometricInfoData(requestId);
 ...
 // haghshenas
    ...
    public boolean removeFingerAllTypeData(long requestId) throws BaseException {
    	...
    	{
    		if (type == BiometricType.FING_ALL || type == BiometricType.FING_CANDIDATE || type == BiometricType.FING_MIN_1 || type == BiometricType.FING_MIN_2)
